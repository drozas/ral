...
package body Configuracion_Server is
   ...
   procedure Set_MaxPeticiones(Config: in out TInfoConfiguracion;
                                         Valor: in Natural) is
      --Asigna el maximo nº de peticiones permitidas a una misma conexion.
   begin
   ...
   begin
      ...
      begin
         ...
         --Comprobamos que su tamaño sea mayor que 1B. Si no hay al menos un dominio (es vacío) saltará una excepcion.
