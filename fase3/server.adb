...
begin
   ...
   loop
      ...
      Ada.Text_IO.Put_Line ("Recibida una petición...");

      -- Lectura de la peticion
      LF_Found:= False;

      -- Lectura de la peticion, y la guardamos en un unbounded
      Ada.Text_Io.Put_Line("->LEYENDO PETICION Nº: " & Integer'Image(NPeticion));
      ...
      Ada.Text_IO.Put_Line ("El servidor ha cerrado la conexión...");
