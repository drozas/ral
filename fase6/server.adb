...
procedure server is
   ...
   --Cargamos la configuracion en una auxiliar
   Configuracion_General: TInfoConfiguracion;
...
begin
   ...
   CargarConfiguracion(Configuracion_General);
   loop

      --Creamos un nuevo registro
      DatosTarea := new Tarea_Conexion.InfoTarea;
      --Y ahora se la pasamos..
      DatosTarea.Configuracion:=Configuracion_General;
